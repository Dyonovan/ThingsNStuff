...
public class ModelWire extends ModelBase
{
    ...
    ModelRenderer midWire;
    ModelRenderer topWire;
    ModelRenderer bottomWire;
    ModelRenderer backWire;
    ModelRenderer frontWire;
    ModelRenderer rightWire;
    ModelRenderer leftWire;
    ...
    public ModelWire()
    {
        ...
        midWire = new ModelRenderer(this, 56, 0);
        midWire.addBox(0F, 0F, 0F, 2, 2, 2);
        midWire.setRotationPoint(-1F, 15F, -1F);
        midWire.setTextureSize(64, 64);
        midWire.mirror = true;
        setRotation(midWire, 0F, 0F, 0F);
        topWire = new ModelRenderer(this, 56, 4);
        topWire.addBox(0F, 0F, 0F, 2, 7, 2);
        topWire.setRotationPoint(-1F, 8F, -1F);
        topWire.setTextureSize(64, 64);
        topWire.mirror = true;
        setRotation(topWire, 0F, 0F, 0F);
        bottomWire = new ModelRenderer(this, 56, 13);
        bottomWire.addBox(0F, 0F, 0F, 2, 7, 2);
        bottomWire.setRotationPoint(-1F, 17F, -1F);
        bottomWire.setTextureSize(64, 64);
        bottomWire.mirror = true;
        setRotation(bottomWire, 0F, 0F, 0F);
        backWire = new ModelRenderer(this, 38, 17);
        backWire.addBox(0F, 0F, 0F, 2, 2, 7);
        backWire.setRotationPoint(-1F, 15F, 1F);
        backWire.setTextureSize(64, 64);
        backWire.mirror = true;
        setRotation(backWire, 0F, 0F, 0F);
        frontWire = new ModelRenderer(this, 38, 4);
        frontWire.addBox(0F, 0F, 0F, 2, 2, 7);
        frontWire.setRotationPoint(-1F, 15F, -8F);
        frontWire.setTextureSize(64, 64);
        frontWire.mirror = true;
        setRotation(frontWire, 0F, 0F, 0F);
        rightWire = new ModelRenderer(this, 38, 0);
        rightWire.addBox(0F, 0F, 0F, 7, 2, 2);
        rightWire.setRotationPoint(-8F, 15F, -1F);
        rightWire.setTextureSize(64, 64);
        rightWire.mirror = true;
        setRotation(rightWire, 0F, 0F, 0F);
        leftWire = new ModelRenderer(this, 38, 13);
        leftWire.addBox(0F, 0F, 0F, 7, 2, 2);
        leftWire.setRotationPoint(1F, 15F, -1F);
        leftWire.setTextureSize(64, 64);
        leftWire.mirror = true;
        setRotation(leftWire, 0F, 0F, 0F);
